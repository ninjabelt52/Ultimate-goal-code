...
@TeleOp(name = "vuforia auto correct")
@Disabled
public class vuCorrect_Test extends LinearOpMode {
        ...
        while (opModeIsActive()){
            ...
            if (targetVisible) {
                ...
                telemetry.addData("Rot (deg)", "{Roll, Pitch, Heading} = %.0f, %.0f, %.0f", rotation.firstAngle, rotation.secondAngle, rotation.thirdAngle);
                 ...
                 xVal = translation.get(0);
                 yVal = translation.get(1);

                 correctionX = (xVal - (-8.7)) / xVal;
                 correctionY = (yVal - 4) / 4;

                backLeftWheel.setPower(correctionX * .3);
                backRightWheel.setPower(correctionX * .3);
                frontLeftWheel.setPower(correctionX * .3);
                frontRightWheel.setPower(correctionX * .3);


                 /**if (xVal > -8.5){
                     backRightWheel.setPower(.5);
                     backLeftWheel.setPower(.5);
                     frontRightWheel.setPower(.5);
                     frontLeftWheel.setPower(.5);
                 }
            ...
            telemetry.addData("back left motor speed:",backLeftWheel.getPower());
            telemetry.addData("back right motor speed:",backRightWheel.getPower());
            telemetry.addData("front left motor speed:",frontLeftWheel.getPower());
            telemetry.addData("front right motor speed:",frontRightWheel.getPower());
            telemetry.addData("correction for x axis:",correctionX);
            telemetry.update();
        }
